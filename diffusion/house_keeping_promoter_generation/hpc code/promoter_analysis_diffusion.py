...
save_path = '/scratch/kg3163/promoters/generate_sequences_alt/promoter_weights_mega.pth'
...
for i in range(batch_size):
  a = samples[-1][i].reshape(image_size[0], image_size[1], channels)
  a_shape = a.shape
  a = a.reshape(a_shape[0], a_shape[1])[:, :250]
