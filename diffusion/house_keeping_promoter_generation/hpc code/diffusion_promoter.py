...
data_path =   "/scratch/kg3163/promoters/data/save_data_house_keeping_promoter.npy"
labels_path = "/scratch/kg3163/promoters/data/save_labels_house_keeping_promoter.npy"
class MyDataset(Dataset):
    def __init__(self, data_path, labels_path):
        self.pixel_values = np.expand_dims(np.load(data_path, allow_pickle=True), axis = 1)
        print("loaded")
...
dataset = MyDataset(data_path, labels_path)
batch_size = 1024
...
weight_save_path = '/scratch/kg3163/promoters/HousekeepingAltTests/promoter_weights_mega.pth'
