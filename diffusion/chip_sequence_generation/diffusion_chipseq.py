...
class MyDataset(Dataset):
    def __init__(self, drive_path):
        self.pixel_values = np.expand_dims(np.load(os.path.join(drive_path, 'save_data_chipseq_bar_N.npy')), axis = 1)
        self.labels = np.load(os.path.join(drive_path, 'save_labels_chipseq_bar_N.npy'))
...
dataset = MyDataset("/gpfs/scratch/ja4431/ChipSeqRun/")
batch_size = 20
...
save_path = '/gpfs/scratch/ja4431/ChipSeqRun/chipseq_bar_N_weights.pth'
