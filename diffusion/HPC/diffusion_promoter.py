...
data_path =   "/scratch/kg3163/promoters/data/save_data_promoter.npy"
labels_path = "/scratch/kg3163/promoters/data/save_labels_promoter.npy'"
class MyDataset(Dataset):
    def __init__(self, data_path, labels_path):
        self.pixel_values = np.expand_dims(np.load(data_path), axis = 1)
...
weight_save_path = '/scratch/kg3163/promoters/A/promoter_weights.pth'
